...
exec(open(os.path.join("web", "dispatch", "meta", "release.py")).read())
...
setup(
	name = "web.dispatch.meta",
	version = version,
	
	description = description,
	long_description = codecs.open(os.path.join(here, 'README.rst'), 'r', 'utf8').read(),
	url = url,
	download_url = 'https://warehouse.python.org/project/web.dispatch.meta/',
	...
	entry_points = {
			'web.dispatch': [
					'transition = web.dispatch.meta:TransitionDispatch',
				],
		},
